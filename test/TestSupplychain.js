...
contract('SupplyChain', function(accounts) {
    ...
    it("Testing smart contract function shipItem() that allows a distributor to ship coffee", async() => {
        ...
        assert.equal(resultBufferOne[0], sku, 'Error: Invalid item SKU')
        assert.equal(resultBufferOne[1], upc, 'Error: Invalid item UPC')
        assert.equal(resultBufferOne[3], originFarmerID, 'Error: Missing or Invalid origenFarmerID')
        assert.equal(resultBufferTwo[4], productPrice, 'Error: Invalid item price')
    ...
    it("Testing smart contract function fetchItemBufferTwo() that allows anyone to fetch item details from blockchain", async() => {
        ...
        assert.equal(resultBufferTwo[3], productNotes, 'Error: Missing or Invalid Notes')
        assert.equal(resultBufferTwo[4], productPrice, 'Error: Missing or Invalid Price')
